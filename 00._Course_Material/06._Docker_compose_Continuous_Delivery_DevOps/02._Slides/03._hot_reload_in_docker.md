...
Run where the `compose.dev.yml` file is located:
...
To run the application locally, cd to `src` where the `compose.dev.yaml` file is and run the following command:
