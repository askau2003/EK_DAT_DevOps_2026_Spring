...
Install [ctop](https://github.com/bcicen/ctop) with `brew` / `scoop`.
...
Install [LazyDocker](https://github.com/jesseduffield/lazydocker?tab=readme-ov-file) with `brew` / `scoop`.
